...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull LinearLayout rootView, @NonNull FloatingActionButton btnCart,
      @NonNull RecyclerView recyclerMenu, @NonNull SwipeRefreshLayout swipeRefreshLayout,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((LinearLayout) rootView, btnCart, recyclerMenu,
